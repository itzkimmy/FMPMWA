    ...
    <div className="max-w-5xl space-y-5 animate-fade-in pb-10 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          <Link
            href="/reports"
            className="px-3 py-1.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 hover:text-amber-300 text-xs font-semibold rounded-lg transition-colors flex items-center gap-1.5"
          >
